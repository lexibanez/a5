...
class DirectMessenger:
    ...
    def retrieve_new(self) -> list:
        ...
        messages_tuple = direct_message(self.dsuserver, self.port, self.username, self.password, 'new')
        return messages_tuple.messages
    
    def retrieve_all(self) -> list:
        # must return a list of DirectMessage objects containing all messages
        messages_tuple = direct_message(self.dsuserver,self.port, self.username, self.password, 'all')
        return messages_tuple.messages